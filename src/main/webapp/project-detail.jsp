            ...
            <div class="page-banner-content text-center">
                ...
                <div class="breadcrumbs" data-aos="fade-up" data-aos-delay="100">
                    <ul>
                        ...
                        <li><span><c:out value="${project.title}"/></span></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="project-main-image" data-aos="fade-up">
                        <img src="${pageContext.request.contextPath}${not empty project.imageUrl ? project.imageUrl : '/resources/images/default-project-large.jpg'}"
                ...
                <div class="col-lg-4">
                    <aside class="project-sidebar">
                        ...
                        <div class="sidebar-widget project-info-widget" data-aos="fade-left" data-aos-delay="100">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div><strong>Bắt đầu:</strong> <fmt:formatDate value="${project.startDate}" pattern="dd/MM/yyyy" /></div>
                                </li>
                                <c:if test="${not empty project.endDate}">
                                    <li>
                                        <i class="fas fa-calendar-check"></i>
                                        <div><strong>Hoàn thành:</strong> <fmt:formatDate value="${project.endDate}" pattern="dd/MM/yyyy" /></div>
                                    </li>
                                </c:if>
                                ...
                                <c:if test="${not empty project.link && project.link ne '#'}">
                                    <li>
                                        <i class="fas fa-link"></i>
                                        <div><strong>Website dự án:</strong> <a href="${fn:escapeXml(project.link)}" target="_blank" rel="noopener noreferrer">Truy cập</a></div>
                                    </li>
                                </c:if>
                            </ul>
                        </div>
                        ...
                        <div class="sidebar-widget contact-form-widget" data-aos="fade-left" data-aos-delay="200">
                            ...
                            <form action="${pageContext.request.contextPath}/contact" method="post"> <%-- Or a dedicated servlet --%>
                                <input type="hidden" name="subject" value="Yêu cầu tư vấn dự án: ${fn:escapeXml(project.title)}">
                                ...
                                <div class="form-group">
                                    <textarea name="message" class="form-control" rows="3" placeholder="Nội dung yêu cầu..."></textarea>
                                </div>
                                            ...
                                            <div class="related-project-item">
                                                <div class="related-project-img">
                                                    <a href="${pageContext.request.contextPath}/projects/detail?id=${related.id}">
                                                        <img src="${pageContext.request.contextPath}${not empty related.imageUrl ? related.imageUrl : '/resources/images/default-project-thumb.jpg'}"
